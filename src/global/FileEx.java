		...
		try {
			while (true) {
				...
				case "1":
					...
					file = new File("C:\\Users\\hb2002\\workspace\\" + fileName + ".txt");
				...
				case "4":
					...
					File updateFile = new File("C:\\Users\\hb2002\\workspace\\" + updateFileName + ".txt");
				...
				case "5":
					...
					File delFile = new File("C:\\Users\\hb2002\\workspace\\" + delFileName + ".txt");
					delFile.delete();
					break;
				case "0":
					fw.close();
